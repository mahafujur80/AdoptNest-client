    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      ...
      <div className="text-center">
        ...
        <div className="relative mb-8">
          ...
          <div className="absolute inset-0 rounded-full animate-ping opacity-20 bg-emerald-400 w-24 h-24 mx-auto"></div>
          <div className="absolute inset-0 rounded-full animate-pulse opacity-30 bg-emerald-300 w-24 h-24 mx-auto"></div>
          
          
          <div className="relative bg-gradient-to-br from-emerald-500 to-teal-500 w-24 h-24 rounded-2xl flex items-center justify-center mx-auto shadow-lg animate-bounce">
